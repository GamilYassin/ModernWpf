...
namespace ModernWpf.Controls.Primitives
{
	public sealed class ComboBoxHelper
	{
		...
		private static void OnDropDownOpened(object sender, object args)
		{
			...
			// We need to know whether the dropDown opens above or below the ComboBox in order to
			// update corner radius correctly. Sometimes TransformToPoint value is incorrect because
			// popup is not fully opened when this function gets called. Use dispatcher to make sure
			// we get correct VerticalOffset.

...
namespace ModernWpf.Controls.Primitives
{
	public static class FocusVisualHelper
	{
		...
		/// <summary>
		///  Gets the brush used to draw the outer border of a HighVisibility focus visual for a FrameworkElement.
		/// </summary>
		/// <param name="element">
		///  The element from which to read the property value.
		/// </param>
		...
		/// <summary>
		///  Gets the thickness of the outer border of a HighVisibility focus visual for a FrameworkElement.
		/// </summary>
		/// <param name="element">
		///  The element from which to read the property value.
		/// </param>
		/// <returns>
		///  The thickness of the outer border of a HighVisibility focus visual. The default value
		///  is 2.
		/// </returns>
		...
		/// <summary>
		///  Gets the brush used to draw the inner border of a HighVisibility focus visual for a FrameworkElement.
		/// </summary>
		/// <param name="element">
		///  The element from which to read the property value.
		/// </param>
		...
		/// <summary>
		///  Gets the thickness of the inner border of a HighVisibility focus visual for a FrameworkElement.
		/// </summary>
		/// <param name="element">
		///  The element from which to read the property value.
		/// </param>
		/// <returns>
		///  The thickness of the inner border of a HighVisibility focus visual. The default value
		///  is 1.
		/// </returns>
		...
		/// <summary>
		///  Gets the value of the Control.IsTemplateFocusTarget XAML attached property for the
		///  target element.
		/// </summary>
		/// <param name="element">
		...
		/// <summary>
		///  Gets a value that indicates whether the control uses focus visuals that are drawn by
		///  the system or those defined in the control template.
		/// </summary>
		/// <param name="control">
		///  The object from which the property value is read.
		/// </param>
		/// <returns>
		///  **true** if the control uses focus visuals drawn by the system; **false** if the
		///  control uses focus visuals defined in the ControlTemplate. The default is
		///  **false**; see Remarks.
		/// </returns>
		...
		/// <summary>
		///  Sets a value that indicates whether the control uses focus visuals that are drawn by
		///  the system or those defined in the control template.
		/// </summary>
		/// <param name="control">
		///  The object to which the property value is written.
		...
		private sealed class FocusVisualAdorner : Adorner
		{
			...
			/// <summary>
			///  Derived classes override this property to enable the Visual code to enumerate the
			///  Visual children. Derived classes need to return the number of children from this method.
			///
			...
			/// <summary>
			///  Default control arrangement is to only arrange the first visual child. No
			...
			/// <summary>
			///  Derived class must implement to support Visual children. The method must return the
			///  child at the specified index. Index must be between 0 and GetVisualChildrenCount-1.
			///
			///  By default a Visual does not have any children.
			///
			///  Remark: During this virtual call it is not valid to modify the Visual tree.
			/// </summary>

...
{
	/// <summary>
	///  ContentPresenter is used within the template of a content control to denote the place in
	///  the control's visual tree (control template) where the content is to be added.
	/// </summary>
	public class ContentPresenterEx : ContentPresenter
	{
		...
		/// <summary>
		///  The TextWrapping property controls whether or not text wraps when it reaches the flow

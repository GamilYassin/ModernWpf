...
namespace ModernWpf.Controls
{
	...
	public class SimpleStackPanel : Panel
	{
		...
		/// <summary>
		///  Gets a value that indicates if this SimpleStackPanel has vertical or horizontal orientation.
		/// </summary>
		/// <returns>
		...
		///  direction of the SimpleStackPanel's Orientation.
		/// </summary>
		/// <returns>
		...
		/// <summary>
		///  Measures the child elements of a SimpleStackPanel in anticipation of arranging them
		///  during the SimpleStackPanel.ArrangeOverride(System.Windows.Size) pass.
		/// </summary>

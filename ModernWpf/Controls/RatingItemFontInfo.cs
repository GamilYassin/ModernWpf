...
namespace ModernWpf.Controls
{
	...
	public class RatingItemFontInfo : RatingItemInfo
	{
		...
		/// <summary>
		///  Gets or sets a Segoe MDL2 Assets font glyph that represents a rating element that has
		...
		/// <summary>
		///  Gets or sets a Segoe MDL2 Assets font glyph that represents a rating element that is
		...
		/// <summary>
		///  Gets or sets a Segoe MDL2 Assets font glyph that represents a rating element showing a
		///  placeholder value with the pointer over it.
		/// </summary>
		/// <returns>
		///  The hexadecimal character code for the rating element glyph.
		/// </returns>
